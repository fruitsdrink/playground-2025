    ...
    <div className="max-w-5xl mx-auto px-6 py-16 bg-gray-900">
      ...
      <div className="flex flex-col md:flex-row md:items-start items-center gap-10 mb-12">
        ...
        <div>
          ...
          <p className="text-gray-300 text-lg">
            I'm a passionate web developer and contetn creator who loves
            building friendly digital experiences ad helping others grow into
      ...
      <div className="mb-12">
        ...
        <p className="text-gray-300 leading-relaxed">
          ...
          learned with others - not juset about code, but about building a life
          you're proud of. Throung tutorials, courses, and real-world projects,
